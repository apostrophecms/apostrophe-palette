...
module.exports = {
  ...
  construct: function (self, options) {
    ...
    self.getCreateSingletonOptions = function (req) {
      ...
      browserOptions.schema = self.apos.docs.getManager('apostrophe-global').find(req, {}).options.module.schema
      browserOptions.target = self.options.target;
      browserOptions.modifier = self.options.modifierSeparator || '--';
