apos.define('apostrophe-palette-widgets', {
  ...
  afterConstruct: function(self) {
    // Don't hammer the server too hard when sliders are moving
    self.debouncedSave = _.debounce(self.save, 1000, { leading: true, trailing: true });
  },
  ...
  construct: function (self, options) {
    ...
    self.submit = function ($field, fieldValue, fieldSchema, $tag) {
      ...
      self.debouncedSave($field, fieldValue, fieldSchema, $tag);
    };
